...
contract structs{
    ...
    function breedingParty() external{
        ...
        Dog memory clifford = Dog({tweaking:false, owner:address(1), bark:"rrrrrrrrrOOOOOOOOOOFFFFFFFFFFFFF NIGGA!", size:9});//This is another way to initialize the values of a struct
        ...
        Dog memory basicBitch;
        basicBitch.bark="grrr"; basicBitch.size=5; basicBitch.tweaking=false; basicBitch.owner=address(999/*she belongs to the streets lol*/);//You can put these on separate lines but I just didn't want to

        doges.push(cujo);//Just adding some created structs to the struct array
        doges.push(clifford);
        doges.push(dmx);
        doges.push(basicBitch);
        ...
        _dog.bark="Excuse me, whore. I am a civilized canine, I do not bark like the other basic bitches. I can articulate my words even more effectively than you. Show some respect.";//This will uodate the struct in the array. As long as you identify the struct appropriately, it can be updated directly like this w/o having to mess around w/ array syntax & manipulation
